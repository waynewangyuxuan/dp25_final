...
from src.attacks.fgsm import fgsm_attack, generate_fgsm_examples
...
log_filename = os.path.join(log_dir, f"task2_fgsm_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
class Logger:
